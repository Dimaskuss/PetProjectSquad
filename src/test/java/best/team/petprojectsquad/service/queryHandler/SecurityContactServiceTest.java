...
class SecurityContactServiceTest {

    SecurityContactService securityContactService = new SecurityContactService();
    ...
    void getReplyMessage() {
        ...
        assertEquals(requestArrayList.get(0).getParameters(), securityContactService.getReplyMessage(ID).get(0).getParameters());
    }
}