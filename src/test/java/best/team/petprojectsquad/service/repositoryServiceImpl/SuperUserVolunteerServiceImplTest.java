...
import static org.junit.jupiter.api.Assertions.*;
    ...
    class SuperUserVolunteerServiceImplTest {
        @Mock
        best.team.petprojectsquad.repository.SuperUserVolunteerRepository UserRepository;
        @InjectMocks
        SuperUserVolunteerServiceImpl UserControllerService;
        long id = 0L;
        best.team.petprojectsquad.entity.SuperUserVolunteer User = new SuperUserVolunteer(1L);
