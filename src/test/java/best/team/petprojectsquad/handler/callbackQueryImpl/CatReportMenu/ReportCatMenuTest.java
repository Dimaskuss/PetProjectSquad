...
import best.team.petprojectsquad.handler.callbackQueryImpl.CatReportMenu.ReportCatMenu;
...
class ReportCatMenuTest {

    @Mock
    ReportMenuCatService service;

    @InjectMocks
    private ReportCatMenu catQuery;

    long id = 1005223990L;
    private BotState botState = BotState.CAT_REPORT_MENU;
