...
import best.team.petprojectsquad.handler.callbackQueryImpl.CatInfoMenu.InfoMenuCatQuery;
...
class InfoMenuCatQueryTest {

    @Mock
    InfoMenuCatQueryService service;

    @InjectMocks
    private InfoMenuCatQuery catQuery;
    ...
    private BotState botState = BotState.CAT_INFO_MENU;
