...
class DogCallbackQueryTest {

    @Mock
    DogCallbackQueryService service;

    @InjectMocks
    private DogCallbackQuery dogQuery;

    long id = 1005223990L;
    private final BotState botState = BotState.DOG_SHELTER_CALLBACK;
