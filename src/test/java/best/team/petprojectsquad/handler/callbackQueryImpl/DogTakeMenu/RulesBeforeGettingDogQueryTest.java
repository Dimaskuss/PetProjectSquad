...
import best.team.petprojectsquad.handler.callbackQueryImpl.DogTakeMenu.RulesBeforeGettingDogQuery;
...
class RulesBeforeGettingDogQueryTest {

    @Mock
    RulesBeforeGettingDogService service;

    @InjectMocks
    private RulesBeforeGettingDogQuery catQuery;

    long id = 1005223990L;
    private BotState botState = BotState.RULES_TAKE_DOG;
