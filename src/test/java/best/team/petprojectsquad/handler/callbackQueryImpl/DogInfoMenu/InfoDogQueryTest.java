...
import best.team.petprojectsquad.handler.callbackQueryImpl.DogInfoMenu.InfoDogQuery;
import best.team.petprojectsquad.service.queryHandlerImpl.DogInfoMenuService.InfoDogQueryService;
...
class InfoDogQueryTest {

    @Mock
    InfoDogQueryService service;

    @InjectMocks
    private InfoDogQuery dogQuery;
    ...
    private BotState botState = BotState.DOG_SHELTER_INFO;
