...
import best.team.petprojectsquad.service.queryHandlerImpl.DogTakeMenuService.HomeRecommendationsPuppyService;
...
class HomeRecommendationsPuppyQueryTest {

    @Mock
    HomeRecommendationsPuppyService service;

    @InjectMocks
    private HomeRecommendationsPuppyQuery dogQuery;

    long id = 1005223990L;
    private final BotState botState = BotState.HOME_RECOMMENDATION_PUPPY;
