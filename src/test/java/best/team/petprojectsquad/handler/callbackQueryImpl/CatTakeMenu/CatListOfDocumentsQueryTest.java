...
class CatListOfDocumentsQueryTest {

    @Mock
    CatListOfDocumentsService service;

    @InjectMocks
    private CatListOfDocumentsQuery catQuery;

    long id = 1005223990L;
    private final BotState botState = BotState.CAT_TAKE_DOCUMENTS;
