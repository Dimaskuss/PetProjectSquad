...
import best.team.petprojectsquad.handler.callbackQueryImpl.DogInfoMenu.InfoMenuDogQuery;
...
class InfoMenuDogQueryTest {

    @Mock
    InfoMenuDogQueryService service;

    @InjectMocks
    private InfoMenuDogQuery dogQuery;
    ...
    private BotState botState = BotState.DOG_INFO_MENU;
