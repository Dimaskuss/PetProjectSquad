...
import best.team.petprojectsquad.service.queryHandlerImpl.DogTakeMenuService.HomeRecommendationsDogWithDisabilitiesService;
...
class HomeRecommendationsDogWithDisabilitiesQueryTest {

    @Mock
    HomeRecommendationsDogWithDisabilitiesService service;

    @InjectMocks
    private HomeRecommendationsDogWithDisabilitiesQuery dogQuery;

    long id = 1005223990L;
    private final BotState botState = BotState.HOME_RECOMMENDATION_DIS_DOG;
