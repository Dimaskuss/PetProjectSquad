...
@Component
@AllArgsConstructor
public class CatValidatePhoneHandler implements InputHandlerMessage {

    private final CatValidatePhoneService catValidatePhoneService;

    @Override
    public List<BaseRequest> handle(Message inputMessage) {
        return catValidatePhoneService.getReplyMessage(inputMessage);
    }

    @Override
    public BotState getHandlerName() {
        return BotState.CAT_VALIDATE_CALLBACK;
    }
}
